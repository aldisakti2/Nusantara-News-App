...
import 'package:nusantara_news_app/pages/portofolio_page.dart';
        ...
        child: Stack(
            children: <Widget>[
              Positioned(
                  top: 53,
                  left: 19,
                  child: Text('Notifikasi', textAlign: TextAlign.left, style: kHeading6.copyWith(
                    color: kBlack,
                  ),)
              ),Positioned(
                  top: 105,
                                                    ...
                                                    Positioned(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                              ...
                                                              color : Color.fromRGBO(247, 56, 89, 0.15000000596046448),
                                                            )
                                                        )
                                                    ),Positioned(
                                                        top: 9,
